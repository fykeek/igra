...
int main() {
    ...
    Button BmenuStart = {300, 300, 600, 100, "СТАРТ", TX_BLACK, TX_LIGHTCYAN, RGB(253, 251, 179), 5, 1, 85};
    Button BmenuHelp = {300, 450, 600, 100, "ПОМОЩЬ", TX_BLACK, TX_LIGHTCYAN, RGB(253, 251, 179), 5, 1, 85};
    Button BmenuExit = {300, 600, 600, 100, "ВЫХОД", TX_BLACK, TX_LIGHTCYAN, RGB(253, 251, 179), 5, 1, 85};


    Button BmenuResume = {300, 275, 600, 100, "ПРОДОЛЖИТЬ", TX_BLACK, TX_LIGHTCYAN, RGB(253, 251, 179), 5, 1, 85};
    Button BmenuMenu = {300, 425 , 600, 100, "ВЫЙТИ", TX_BLACK, TX_LIGHTCYAN, RGB(253, 251, 179), 5, 1, 85};
    ...
    while (PAGE != "exit") {
        ...
        if(PAGE == "menu") {
            ...
            txDrawText(0, 0, 1200, 300, "УЖАСНАЯ КАПЧА");
        ...
        if (PAGE == "help") {
            ...
            txDrawText(0, -95 , 1200, 800 - 95, "Используй WASD для управления!");
            txDrawText(0, 0, 1200, 800, "GitHab автора: fykeek");
